...
//             </button>
//             <div class="collapse mt-2" id="${hotel.id}-address">
//                 <div class="card card-body">${createAddress(
//                   hotel.address
//                 )}</div>
//             </div>
//             </td>
...
//   const statusButtons = d.querySelectorAll(".status-btn");

//   for (let i = 0; i < statusButtons.length; i++) {
//     const btn = statusButtons[i];
//     const hotelId = btn.dataset.hotelId;
//     const isApproved = btn.dataset.isApproved;
//     console.log(hotelId, isApproved);

//     btn.addEventListener("click", async (e) => {
//       console.log(
//         hotelId,
//         isApproved,
//         isApproved == "true" ? "block" : "approve"
//       );
...
//       ) {
//         // api request
//         const newApprovalStatus = isApproved == "true" ? false : true;
//         const url = `http://localhost:5229/hotel/status_update?hotelId=${hotelId}&newApprovalStatus=${newApprovalStatus}`;
...
//           if (response.ok) {
//             btn.className = `status-btn badge ${
//               newApprovalStatus ? "text-bg-success" : "text-bg-danger"
//             }`;

//             btn.innerText = newApprovalStatus ? "Approved" : "Not Approved";
//           }
//         } catch (error) {
//           console.error(error);
//         }

...
{
    public partial class hotel_address : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNoAndName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StreetNoAndName = table.Column<string>(type: "nvarchar(max)", nullable: false),
